      ...
      <div className="container">
        ...
        >
          ...
          {testimonialsItems.map((item, index) => (
            ...
            >
              <p>{item.text}</p>
              <div className="flex item-center justify-between flex-wrap pt-4 border-t border-t-green-90 gap-4">
        ...
        <div className="flex items-center justify-center mt-18 gap-5 ">
          <button className="bg-green-70 w-12 h-12 flex items-center justify-center rounded-md hover:bg-green-75 transition-colors active:bg-green-75/80 prev-btn">
            <RiArrowLeftLine size={30} />
          </button>
          <button className="bg-green-70 w-12 h-12 flex items-center justify-center rounded-md hover:bg-green-75 transition-colors active:bg-green-75/80 next-btn">

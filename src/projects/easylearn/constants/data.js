...
export const heroLogos = [
  { id: 1, item: base + "easylearn/logo-1.png", width: 56 },
  { id: 2, item: base + "easylearn/logo-2.png", width: 82 },
  { id: 3, item: base + "easylearn/logo-3.png", width: 57 },
  { id: 4, item: base + "easylearn/logo-4.png", width: 64 },
  { id: 5, item: base + "easylearn/logo-5.png", width: 78 },
  { id: 6, item: base + "easylearn/logo-6.png", width: 75 },
  { id: 7, item: base + "easylearn/logo-7.png", width: 65 },
];
export const benefitItems = [
  {
    id: 1,
    icon: base + "/easylearn/icon-1.png",
    title: "Flexible Learning Schedule",
    text: "Fit your coursework around your existing commitments and obligations.",
  },
  {
    id: 2,
    icon: base + "/easylearn/icon-2.png",
    title: "Expert Instruction",
    text: "Learn from industry experts who have hands-on experience in design and development.",
  },
  {
    id: 3,
    icon: base + "/easylearn/icon-3.png",
    title: "Diverse Course Offerings",
    text: "Explore a wide range of design and development courses covering various topics.",
  },
  {
    id: 4,
    icon: base + "/easylearn/icon-4.png",
    title: "Updated Curriculum",
    text: "Access courses with up-to-date content reflecting the latest trends and industry practices.",
  },
  {
    id: 5,
    icon: base + "/easylearn/icon-5.png",
    title: "Practical Projects and Assignments",
    text: "Develop a portfolio showcasing your skills and abilities to potential employers.",
  },
  {
    id: 6,
    icon: base + "/easylearn/icon-6.png",
...
export const coursesSecItems = [
  {
    id: 1,
    img: base + "/easylearn/course-img-1.png",
  ...
  {
    id: 2,
    img: base + "/easylearn/course-img-2.png",
  ...
  {
    id: 3,
    img: base + "/easylearn/course-img-3.png",
  ...
  {
    id: 4,
    img: base + "/easylearn/course-img-4.png",
    title: "UI/UX Design",
  ...
  {
    id: 5,
    img: base + "/easylearn/course-img-5.png",
  ...
  {
    id: 6,
    img: base + "/easylearn/course-img-6.png",
...
export const testimonialsItems = [
  {
    ...
    author: "Sarah L",
    img: base + "/easylearn/testi-img-1.png",
  },
  {
    id: 2,
    ...
    author: "Jason M",
    img: base + "/easylearn/testi-img-2.png",
  },
  {
    id: 3,
    ...
    author: "Emily R",
    img: base + "/easylearn/testi-img-3.png",
  },
  {
    id: 4,
    ...
    author: "Michael K",
    img: base + "/easylearn/testi-img-4.png",
  },
];

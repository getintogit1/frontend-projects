...
import { navigation } from "../constants/data.js";
  ...
  return (
    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        <a className="block w-[rem] xl:mr-8" href="#hero">
          <img src={brainwave} width={190} height={190} alt="Brainwave" />
        </a>
        <nav
          className={`fixed top-[5rem] left-0 right-0 bottom-0 bg-n-8 lg:static lg:bg-transparent lg:mx-auto lg:flex
